  ...
  return (
    <Card className="shadow-md w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Generate a full offline backup of all application data from Firestore.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="border rounded-lg p-4 space-y-3">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                <li><span className="font-medium text-foreground">Firestore Data:</span> All Users, Customers, Services, Products, Tasks, Invoices, Attendance, Categories, and Company Profile.</li>
            </ul>
