...
export async function addInvoice(data: z.infer<typeof CreateInvoiceSchema>): Promise<AddInvoiceResult> {
  ...
  if (!validation.success) {
    ...
    return { success: false, message: 'Invalid invoice data provided to server action.' };
  }
  ...
  try {
    ...
    if (typeof invoiceDataForFirestore.customerNumber === 'undefined') {
     ...
     if (typeof invoiceDataForFirestore.customerId === 'undefined') {
      delete invoiceDataForFirestore.customerId;
    }
