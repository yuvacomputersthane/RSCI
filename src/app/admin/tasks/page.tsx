...
import { PlusCircle, ClipboardList, AlertTriangle, RefreshCw, Trash2, CheckCircle, Circle } from 'lucide-react';
...
export default function TaskManagementPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setError(null);
    try {
      const [tasksResult, usersResult] = await Promise.all([getTasks(), getFirebaseUsers()]);
