                  ...
                  <TableRow key={invoice.id}>
                    <TableCell className="font-mono">
                       <Button variant="link" asChild className="p-0 h-auto font-normal">
                          <Link href={`/invoice/${invoice.id}`} title="View & Print Invoice">
                    ...
                    <TableCell>{invoice.customerNumber || 'N/A'}</TableCell>
                      ...
                      {invoice.selectedServices && invoice.selectedServices.length > 0 ? (
                        <ul className="list-disc list-inside text-xs">
                          {invoice.selectedServices.map((service, index) => (
                            <li key={`${service.id}-${index}`}>{service.name} (₹{service.price.toFixed(2)})</li>
                          ))}
                        </ul>
                      ) : (
                        'N/A'
