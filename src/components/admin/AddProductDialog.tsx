                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      value={field.value === null || typeof field.value === 'undefined' || (typeof field.value === 'string' && field.value.trim() === '') || isNaN(field.value as number) ? '' : field.value}
                      onChange={e => {
                        const val = e.target.value;
                        field.onChange(val === '' || val === null ? undefined : parseFloat(val) || val);
                      }}
                    />
                  </FormControl>
                  <FormMessage />
